...
async def get_buying_list(message):
    product_info = ('Название: Продукт 1 | Описание: Синие и желтые капсулы, принимать после приема пищи. | Цена: 100 '
                    'руб.')
    with open('1.png', 'rb') as img:
        await message.answer_photo(img, product_info)
    product_info2 = 'Название: Продукт 2 | Описание: Красно-белые капсулы принимать перед едой. | Цена: 200 руб.'
    with open('2.png', 'rb') as img2:
        await message.answer_photo(img2, product_info2)
    product_info3 = 'Название: Продукт 3 | Описание: Розовые таблетки. | Цена: 300 руб.'
    with open('3.png', 'rb') as img3:
        await message.answer_photo(img3, product_info3)
    product_info4 = 'Название: Продукт 4 | Описание: Обычные белые таблетки от чего-то. | Цена: 400 руб.'

class Introspection:
    ...
    def introspection_info(self):
        ...
        attributes = [attr for attr in dir(self.obj) if callable(getattr(self.obj, attr)) and not attr.startswith('_')]
        info['attributes'] = attributes

        methods = [method for method in dir(self.obj) if callable(getattr(self.obj, method)) and not method.startswith('_')]
